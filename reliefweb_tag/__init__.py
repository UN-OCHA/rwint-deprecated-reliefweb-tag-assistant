...
RWModel.create_train_model(vocabulary_name = 'language',
                              vocabulary_file = reliefweb_config.DATA_PATH + reliefweb_config.DATASETS["language"]["vocabulary"], #path+"rw-languages.csv",
                              dataset_file = reliefweb_config.DATA_PATH + reliefweb_config.DATASETS["language"]["dataset"], #path+'report_language-1k.csv',
                              term_field='language',
...
RWModel.create_train_model(vocabulary_name = 'theme',
                              vocabulary_language='',  # values: English, Spanish, French, ''
                              vocabulary_file = reliefweb_config.DATA_PATH + reliefweb_config.DATASETS["theme"]["vocabulary"], # path+"rw-themes.csv",
                              dataset_file = reliefweb_config.DATA_PATH + reliefweb_config.DATASETS["theme"]["dataset"], # path+'report_theme_uneven_multiple-30k.csv',#'report_theme_en-1k.csv',#
                              term_field='theme',
                              dataset_post_field='post',
...
def RWtag():
    ...
    json_data = reliefweb_predict.url_to_tagged_json(model=RWModel, url=sample, threshold=reliefweb_config.THRESHOLD, diff_terms=reliefweb_config.DIFF_TERMS_THRESHOLD)
    return json_data
